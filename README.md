...
An [instance](https://blyzp.github.io/rock-paper-scissors/) of the project [*Revisiting Rock Paper Scissors*](https://www.theodinproject.com/paths/foundations/courses/foundations/lessons/revisiting-rock-paper-scissors) from the ***Foundations*** path of **The Odin Project**.
